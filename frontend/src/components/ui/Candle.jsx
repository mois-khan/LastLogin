  ...
  return (
    <svg width={size} height={size * 1.4} viewBox="0 0 64 90" aria-hidden="true">
      ...
      <g className={still ? "flame flame--still" : "flame"} style={{ transformBox: "fill-box" }}>
        <path d="M32 4 C40 16 46 22 46 34 a14 14 0 0 1 -28 0 C18 22 24 16 32 4 Z" fill="#C8743A" />
        <path d="M32 16 C37 24 40 28 40 35 a8 8 0 0 1 -16 0 C24 28 27 24 32 16 Z" fill="#F2B66B" />
      </g>
      {/* candle body */}
