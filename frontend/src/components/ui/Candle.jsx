...
export default function Candle({ still = false, size = 64 }) {
  ...
  return (
    <svg width={size} height={size * 1.4} viewBox="0 0 64 90" aria-hidden="true">
      ...
      {/* candle body — fill/stroke come from the theme (visible on white, cream on dark) */}
      <rect x="22" y="50" width="20" height="36" rx="4" className="candle-body" />
      <rect x="30" y="46" width="4" height="8" rx="2" fill="#8A8A93" />
    </svg>
  );
}
